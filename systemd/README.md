...
> [!CAUTION]
> Please ensure that you understand the actions of the following commands before executing
...
1. Download apiban-iptables.service and apiban-iptables.timer to `/lib/systemd/system/`
    ...
    * `wget https://raw.githubusercontent.com/apiban/apiban-client-go/main/systemd/apiban-iptables.service`
    * `wget https://raw.githubusercontent.com/apiban/apiban-client-go/main/systemd/apiban-iptables.timer`
